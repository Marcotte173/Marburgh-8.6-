...
public class Shop
{
    ...
    public static List<string> weaponOptionList1 = new List<string> { };
    public static List<string> weaponOptionList2 = new List<string> { };

    public static List<string> armorOptionList1 = new List<string>  { };
    public static List<string> armorOptionList2 = new List<string>  { };

    public static List<string> itemShopTutorialArmorOptionList = new List<string> {  };
    public static List<string> itemShopTutorialWeaponOptionList = new List<string> {  };
    ...
    {
        new Equipment("None", 0, 0,0,0,0,0,0,0,"","",true),
        new Equipment("Dagger", 1, 50,0,0,0,0,0,0,"","",true),           new Equipment("Battered Sword", 3, 150,0,0,0,0,0,0,"","",true),  new Equipment("Short Sword", 5, 300,0,0,0,0,0,0,"","",true),
        new Equipment("Cloth Armor", 1, 50,0,0,0,0,0,0,"","",false),     new Equipment("Battered Armor", 3, 150,0,0,0,0,0,0,"","",false), new Equipment("Soldier's Armor", 5, 300,0,0,0,0,0,0,"","",false)
    };

    public static Shop WeaponShop = new Shop("Billford's weapon emporium.", "Billford", "troll", "Greetings, What can I do for you", WeaponList, weaponOptionList1, weaponOptionList2);
    public static Shop ArmorShop = new Shop("Alya's armor shop.", "Alya", "elf", "Hey there! Looking to buy some armor?", ArmorList, armorOptionList1, armorOptionList2);
    public static Shop Tutorial = new Shop(null, "Elya", null, null, TutorialEquipList, itemShopTutorialWeaponOptionList, itemShopTutorialArmorOptionList);

    public Shop(string name,string shopkeepName, string shopkeepRace, string shopkeepGreeting, Equipment[] ItemList, List<string> list1, List<string> list2)
    {
        this.name = name;
    ...
    {
        {
            ...
            {
                if (p.gold < shop.ItemList[buyChoice].price)
                {
                    UI.Store(new List<int> { 0, 0, 0 }, new List<string>
                    {
