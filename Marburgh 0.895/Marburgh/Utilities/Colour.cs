...
public class Colour
{
    public static string[] magicColour = new string[] { RESET, DAMAGE, HEALTH, GOLD, XP, MITIGATION };
    public static string[] dropColour = new string[] { DROP, RAREDROP };
    public static string[] actionColour = new string[] { ACTION, STUNNED, SPECIAL };
    ...
    public const string SHIELD = "\u001b[38;5;33m";
    ...
    public const string DAMAGE = "\u001b[38;5;160m";
    ...
    public const string ACTION = "\u001b[38;5;50m";
