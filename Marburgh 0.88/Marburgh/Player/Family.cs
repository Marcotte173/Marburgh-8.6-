...
public class Family
{
    ...
    public static List<string> potentialNames = new List<string>
    {
            ...
            "Heather",  "Harold","Hank",
            "Isabelle", "Ian",
            "Jolene",  "Jake", "James", "Jackson", "Jesse",
            "Katherine", "Karl", "Keon", 
            "Laura","Lewis","Larry",
            "Mary",  "Matt","Martin","Melvin","Maebel", "Maddox","Meagen","Magda","Marvin","Mitch","Micah","Mia","Mark",
            "Olivea",
            "Piper"
        };
    ...
    public static void FamilyCreate()
    {
        ...
        Create.f = new Family(Family.LN, Family.FamilyNames[0], Family.FamilyNames[1], Family.FamilyNames[2]);
    }
